...
const PACK_FLAIRS: Record<PuzzleTypeId, Record<Difficulty, { id: string; title: string }>> = {
  ...
  crowns: {
    easy: { id: 'crown-collector', title: 'Crown Collector' },
    medium: { id: 'crown-keeper', title: 'Crown Keeper' },
    hard: { id: 'royal-advisor', title: 'Royal Advisor' },
    genius: { id: 'crowned-head', title: 'Crowned Head' },
  },
  stars: {
    easy: { id: 'stargazer', title: 'Stargazer' },
    medium: { id: 'star-chaser', title: 'Star Chaser' },
    hard: { id: 'constellation', title: 'Constellation' },
    genius: { id: 'supernova', title: 'Supernova' },
  },
  sudoku: {
